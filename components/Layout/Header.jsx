...
const transactions = [
    ...
    },
    {
        ...
        description: 'Start New Transaction',
        href: '/transact/new-transaction',
        icon: ChartBarIcon,
    },
    {
        name: 'Successful Transactions',
        description: 'Transactions that were successfully completed.',
        href: '#',
        icon: CursorClickIcon,
    },
    {
        name: 'Failed Transactions',
        description: 'Transactions that failed and rolled back',
        href: '#',
        icon: ChartBarIcon,
    }
]
                ...
                <div className="max-w-8xl mx-auto px-4 sm:px-6">
                    <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                        ...
                        <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                            {session ?
                                <>
                                    <button onClick={signOut} className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900 px-4">
                                        {session.token.name}
                                    </button>
                                    <button onClick={signOut} className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">
                                        Logout
                                    </button>
                                </> :
                                <>
